...
def time_stats(df, city, month, day):
    ...
    print('The most common start hour of bike share usage in {} during month <{}> on day <{}> is: {}.'.format(city,month,hour_most))
...
def station_stats(df, city,month,day):
    ...
    df['strt end']=df['start station'].map(str)+'  --> '+df['end station'].map(str)
